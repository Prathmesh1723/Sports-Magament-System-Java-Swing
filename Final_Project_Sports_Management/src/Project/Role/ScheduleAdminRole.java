...
import UI.TournamentEnterprise.TournamnetAdminWorkArea;
 ...
 * @author prath
 */
public class ScheduleAdminRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer,UserAccount account,Organization organization,Enterprise enterprise,MainSystem system){
        return new TournamnetAdminWorkArea(userProcessContainer,enterprise,system);
    }   
        @Override
