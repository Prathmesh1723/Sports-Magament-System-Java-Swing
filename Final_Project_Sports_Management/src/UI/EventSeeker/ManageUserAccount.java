...
public class ManageUserAccount extends javax.swing.JPanel {
    ...
    private void populateComboRole(Enterprise e){
        ...
        if(organization instanceof PlayerOrganization){
            comboRole.addItem(new PlayerRole());
    ...
    private void btnAddUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddUserActionPerformed
        ...
        if (organization instanceof PlayerOrganization){
           Player vm = new Player();
            
           vm.setVictimName(person.getPersonName());
           
           ((PlayerOrganization) organization).getChangeseekerlist().getChangeSeekerDirectory().add(vm);
